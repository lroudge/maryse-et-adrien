...
const Header: React.FC = () => {
	...
	return (
		<header className="flex flex-wrap justify-evenly items-center w-full md:h-16 fixed z-10 font-title bg-emerald-500 text-xs md:text-lg text-emerald-900 font-bold shadow-md">
