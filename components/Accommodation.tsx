      ...
      <div className="flex flex-col items-center justify-evenly w-full md:h-112 md:pt-10">
        <div className="flex flex-col justify-evenly items-center h-84 p-x-5 md:h-full w-full">
          ...
          <iframe
            ...
            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS9h6Dq3DfR0fSxzZpkRue_z9oFTB9q4ldKR8l3KZnos_a2hDS4amXqbjvgZZA65_q76e1W5reTHpdB/pubhtml?gid=1575551701&amp;single=true&amp;widget=false&amp;headers=false&amp;range=A1:H17&amp;chrome=false"
          ></iframe>
          <span className="text-sm md:text-xl text-emerald-700">
            Et vous trouverez sur d’autres plateformes web très connues d’autres solutions complémentaires pour vous
            loger !
          </span>
        </div>
